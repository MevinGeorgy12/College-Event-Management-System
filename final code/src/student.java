...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Upcoming Events");
        ...
        jButton6.setText("Upcoming Workshop");
        ...
        jButton2.setText("My Registered events and workshop");
...
ViewNotifications second=new ViewNotifications();
second.setVisible(true);
this.dispose();     // TODO add your handling code here:
...
String studentName = JOptionPane.showInputDialog(this, "Please enter your name to view registrations:", "Enter Name", JOptionPane.QUESTION_MESSAGE);
    

    // 2. Check if a name was entered.
    if (studentName != null && !studentName.trim().isEmpty()) {
        // 3. Open the results page and pass the entered name to it.
        MyRegisteredEvents myRegPage = new MyRegisteredEvents(studentName);
        myRegPage.setVisible(true);
    } else {
